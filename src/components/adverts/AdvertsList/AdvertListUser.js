        ...
        >
            <List.Item key={ad._id}
                ...
                <List.Item.Meta
                    ...
                    title={<>{ad.name}
                        {ad.reserved===true ? <Chip label='Reservado' color="secondary" style={{fontSize: '1.2rem', backgroundColor:'#BC876C', margin:'0 1rem'}}  /> : ad.sold === true ? <Chip label='Vendido' color="secondary" style={{fontSize: '1.2rem', backgroundColor:'#027E0B', margin:'0 1rem'}}  /> : '' }</>}
                    description={ad.description}
                />
                <div className={classes.root}>
                    {ad.type==='buy' ? <Chip label={ad.type} style={{fontSize: '1.2rem', backgroundColor:'#FEF7E6', color:'orange'}}  /> : <Chip label={ad.type} style={{fontSize: '1.2rem', backgroundColor:'#F5FDED', color:'green'}}  /> }
                    {/*<Chip label={ad.type} style={{fontSize: '1.2rem'}}  />*/}
                    <Chip label={ad.tags}  color="primary" style={{fontSize: '1.2rem'}}/>
                    <Chip label={`${ad.price} €`} color="secondary" style={{fontSize: '1.2rem'}}  />
            ...
            <Button
               onClick={() => history.push(`/adverts/${ad?._id}`)}
                ...
                icon={<EyeOutlined
                    ...
                    key="check details" style={{fontSize: '1.1rem'}} />}
